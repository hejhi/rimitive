...
import { signal as latticeSignal, computed as latticeComputed, batch as latticeBatch } from '../../../../core/src/primitives/signals';
...
describe('Large Dependency Graph', () => {
  ...
  bench('Lattice - large graph', () => {
    ...
    const computed1 = latticeComputed(() => sigs.reduce((sum, s) => sum + s.value, 0));
