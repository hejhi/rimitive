 ...
 * ```
 */
export function useViews<Model, Actions, Views, Selected>(
 ...
 * ```
 */
export function useLattice<Model, Actions, Views, Selected>(
  store: ZustandAdapterResult<Model, Actions, Views>,
  viewSelector: (views: ZustandAdapterResult<Model, Actions, Views>['views']) => Selected
): {
  views: Selected;
  actions: Actions;
} {
