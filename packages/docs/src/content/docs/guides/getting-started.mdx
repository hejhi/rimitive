...
Compose only the primitives you need, opting as you go!

In fact, rimitive is as much about providing **scalable patterns, conventions, and mental models** for building performant, lean, ergonomic, and scalable reactive applications as it is about providing the actual reactive primitives you need to do it. So steal the patterns and use a different framework if you don't like rimitive!
