...
<Aside type="note">
React peeps: prefixing with `use*` in rimitive is **just convention and nice semantics**. You can totally use behaviors in vanilla js, no problem. It doesn't grant the function any magical reactive abilities, or require you to obey any rules in how it's used.
</Aside>
