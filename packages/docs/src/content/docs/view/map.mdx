---
title: map()
description: Render reactive lists with efficient reconciliation.
---
...
This is efficient because elements are reused — only the minimal DOM operations are performed.
...
- [Signal Patterns](/patterns/signal-patterns) — Computed collections pattern
