...
```typescript
export declare function compose<T extends Record<string, DefinedService>, TDeps extends ExtractDeps<T>>(factories: T, deps: TDeps, options?: CreateContextOptions): Svc<T>;
```
