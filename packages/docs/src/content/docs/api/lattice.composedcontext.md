...
[Home](./index.md) &gt; [@lattice/lattice](./lattice.md) &gt; [ComposedContext](./lattice.composedcontext.md)
...
```
**References:** [Module](./lattice.module.md)<!-- -->, [ModuleName](./lattice.servicename.md)<!-- -->, [ModuleImpl](./lattice.serviceimpl.md)
