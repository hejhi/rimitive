...
[Home](../../) &gt; [@lattice/router](../) &gt; createRouterModule
...
[Module](../../lattice/module/)<!-- -->&lt;"router", [Router](../router/)<!-- -->, { signal: [SignalFactory](../../signals/signalfactory/)<!-- -->; computed: [ComputedFactory](../../signals/computedfactory/)<!-- -->; }&gt;
