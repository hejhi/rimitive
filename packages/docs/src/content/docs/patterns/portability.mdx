...
Behaviors are more portable than components because they have no UI coupling. A behavior can be used in Lattice views, React, Vue, or anywhere else that can consume signals.
