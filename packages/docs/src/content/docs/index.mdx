...
<CardGrid>
  ...
  <Card title="📦 Tiny Footprint" icon="document">
    Core + Runtime is just 1.5KB gzipped! Complete setup with store-react is only 1.5KB total. That's 8x smaller than Redux Toolkit and 14x smaller than Recoil.
  </Card>
