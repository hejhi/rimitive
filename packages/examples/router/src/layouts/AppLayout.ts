import { createRouteComponent, Link } from '@lattice/router';

export const AppLayout = createRouteComponent(({ el, outlet, currentPath, computed }) => () => {
  return el('div', { className: 'app-layout' })(
    ...
    el('main', { className: 'main-content' })(outlet())
  );
})();
