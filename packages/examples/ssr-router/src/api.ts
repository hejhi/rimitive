/**
 * Shared API for SSR Router Example
 *
 * This API works universally on both server and client.
 * The router automatically detects the environment and uses the appropriate context.
 */
