...
export const apiBasicsComponent = createComponent(() => {
  ...
  const historySlice = createSlice(model, (m, _api) => ({
...
function DebugInfo() {
  ...
  return (
    <div style={{ background: '#e0e0ff', padding: '10px', borderRadius: '5px' }}>
...
function Summary() {
  ...
  return (
    <div style={{ background: '#ffe0e0', padding: '10px', borderRadius: '5px' }}>
...
function History() {
  ...
  return (
    <div style={{ background: '#e0ffe0', padding: '10px', borderRadius: '5px' }}>
      <h3>Action History</h3>
      <p>Total Actions: {history.stats.totalActions}</p>
      <p>Increments: {history.stats.incrementCount} | Decrements: {history.stats.decrementCount}</p>
  ...
  return (
    <div style={{ marginBottom: '20px' }}>
      ...
      <div style={{ marginBottom: '10px' }}>
        ...
        <button onClick={() => actions.decrement()} style={{ marginLeft: '5px' }}>
          Decrement
        </button>
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <p style={{ marginBottom: '20px' }}>
        ...
        <code>getState()</code> and <code>executeSlice()</code>.
        Open the console to see logging output.
      </p>
      ...
      <div style={{ marginTop: '30px', padding: '15px', background: '#fffaf0', borderRadius: '5px' }}>
        <h3>Key Concepts Demonstrated:</h3>
        <ul>
          <li><strong>getState():</strong> Access the current model state from any slice</li>
          <li><strong>executeSlice():</strong> Execute other slices to compose their results</li>
          <li><strong>Logging:</strong> Use API in actions to log state before mutations</li>
          <li><strong>Composition:</strong> Build complex views by combining simpler slices</li>
          <li><strong>Debugging:</strong> Compare model parameter vs API state access</li>
        </ul>
      </div>
    </div>
  );
