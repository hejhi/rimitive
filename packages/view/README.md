...
Reactive DOM primitives for Rimitive applications.
...
el('button').ref(on('click', (e) => console.log('clicked!')))('Click me');

el('input').ref(on('input', (e) => value(e.target.value)))();
```
...
View modules take an adapter — that's how Rimitive stays renderer-agnostic.
...
| El module     | `import { createElModule } from '@rimitive/view/el'`              |
| Map module    | `import { createMapModule } from '@rimitive/view/map'`            |
| Match module  | `import { createMatchModule } from '@rimitive/view/match'`        |
| Portal module | `import { createPortalModule } from '@rimitive/view/portal'`      |
| Mount         | `import { MountModule } from '@rimitive/view/deps/mount'`         |
| Event helper  | `import { OnModule } from '@rimitive/view/deps/addEventListener'` |
