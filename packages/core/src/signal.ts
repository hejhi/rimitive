...
export function createSignalFactory(
  ...
  return function signal<T>(initialValue: T): Signal<T> {
    ...
    const sig = function (...args: any[]) {
      ...
      if (arguments.length === 2 && typeof args[0] === 'function' && typeof args[1] === 'function') {
        ...
        if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
          ...
          if (value instanceof Map) {
            const result = findAndUpdateMapByValuePredicate(value, finder, updater);
            if (result.updated) {
              value = result.value as T;
      ...
      if (arguments.length === 2 && value instanceof Set && typeof args[0] === 'string') {
      ...
      if (arguments.length === 2 && typeof args[1] === 'function') {
        ...
        if (typeof args[0] === 'string' && typeof value === 'object' && value !== null) {
